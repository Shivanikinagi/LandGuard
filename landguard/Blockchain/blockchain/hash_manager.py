...
class EvidenceIntegrityChecker:
    ...
    def check_evidence(self, evidence: Dict, 
        ...
        if not is_valid:
            result['warning'] = '⚠️  Evidence has been tampered with!'
...
if __name__ == "__main__":
    print("🔐 LandGuard Hash Manager Demo\n")
    
    # Initialize hash manager
    hash_mgr = HashManager()
    
    # Example 1: Hash analysis result
    print("1️⃣ Hashing Analysis Result")
    print("─" * 60)
    ...
    print("4️⃣ Verifying Hash Chain")
    print("─" * 60)
    ...
    print(f"✅ Original chain valid: {is_chain_valid}")
    ...
    print(f"❌ Tampered chain valid: {is_chain_valid}\n")
    
    # Example 5: Batch verification
    print("5️⃣ Batch Evidence Verification")
    print("─" * 60)
    ...
    print("\n6️⃣ Content-Addressable ID (CID)")
    print("─" * 60)
